...
help:
	...
	@echo '   make clean_src                      remove ^H in sources               '
...
.PHONY: html help clean clean_src regenerate serve serve-global devserver stopserver publish github create_current_blog_dir post open
